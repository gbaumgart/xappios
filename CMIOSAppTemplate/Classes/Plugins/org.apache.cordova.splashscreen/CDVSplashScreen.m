...
- (void)createViews
{
    ...
    simpleHud=[AppDelegate simpleProgressShowOnWebView:@"Loading" webView:parentView];
...
{
    if(simpleHud){
        //[AppDelegate hideLoadingProgress];
        [simpleHud hide];
//        [simpleHud rele];
//        [simpleHud removeFromS]
    }
...
- (void)setVisible:(BOOL)visible
{
    ...
    _visible = visible;
    if(!visible){
        //[AppDelegate simpleProgressHide];
        if(simpleHud){
            [simpleHud hide];
        }
    }else{
    ...
    NSLog(@"set splashscreen visible :%d",visible);
